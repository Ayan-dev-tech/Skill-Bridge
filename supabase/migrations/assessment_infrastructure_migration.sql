-- =============================================================================
-- Skill-Bridge — Assessment Infrastructure Migration
-- Unified question model for NEET UG, AIAPGET PG, Practical Scenarios, and Industry Skill
-- Run AFTER base schema.sql and ayush_foundation_migration.sql
-- =============================================================================

-- ---------------------------------------------------------------------------
-- 1. Assessment Questions Bank Table
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS public.assessment_questions (
    id                  TEXT PRIMARY KEY,
    question_text       TEXT NOT NULL,
    scenario_context    TEXT,                -- for PRACTICAL_SCENARIO type
    options             JSONB NOT NULL,      -- Options stored as JSONB array [{id,label,text}]
...
-- ---------------------------------------------------------------------------
-- 2. Assessment Configurations Table
-- ---------------------------------------------------------------------------
...
CREATE POLICY "Students can access their own assessment attempts"
    ON public.assessment_attempts FOR ALL USING (auth.uid()::text = student_id);
